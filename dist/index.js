...
export default class OTPInputView extends Component {
    constructor(props) {
        ...
        this.renderOneInputField = (_, index) => {
            const { codeInputFieldStyle, codeInputHighlightStyle, codeInputContainerStyle, secureTextEntry, editable, keyboardType, selectionColor, keyboardAppearance } = this.props;
            ...
            return (<View style={codeInputContainerStyle} pointerEvents="none" key={index + "view"} testID="inputSlotView">
